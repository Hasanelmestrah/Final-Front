  ...
  return (
    <div className="crsl-wrp">
      <div className="holder-pop-carousel">
        <button onClick={handleAddItemButtonClick} className="tab-button">
          <span className="add-item-icon-dash-carousel">&#43;</span>Add Item
        </button>
        <PopupCarousel
          trigger={showPopup}
              ...
              return (
                <tr className="" key={index}>
                  <td className="item-image-carousel">
                    {" "}
                    <img
                      src={item.image_fav.url}
                      alt="product is not displaying"
                    />
                  </td>
                  ...
                  <td>
                    <button
                      ...
                      onClick={() => handleEditButtonClick(item)}></button>
                  </td>
                </tr>
              );
            })}
