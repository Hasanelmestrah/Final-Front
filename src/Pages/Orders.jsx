  ...
  return (
    <>
      <div className="relative w-full h-[100vh]">
        {pop && (
          <div className="absolute w-full h-full   flex align-center justify-center index-1">
            {" "}
            <div
              id="component-parent"
              ...
              <div
                id="cart-parent"
                className=" bg-[white]  h-[46rem]  rounded-md opacity-1 mt-[10%] duration-300">
                <div className="flex flex-col">
                  ...
                  <button
                    className=" hover:cursor-pointer text-white text-xl hover:bg-[white] hover:border-black hover:text-[gray] hover:border-2 bg-[gray] -mt-[5%] ml-[10%] mr-[10%] h-[2.5rem] rounded-md"
                    onClick={clear}>
                    Close
                  </button>
                </div>
                  ...
                  {data
                    ...
                    .map((order, index) => (
                      <TableRow key={index}>
                        ...
                        <TableCell>
                          <button onClick={(event) => seeItems(event, index)}>
                            <img
                              className="h-6 w-6"
                              src={Cart}
                              alt="Cart Logo"
